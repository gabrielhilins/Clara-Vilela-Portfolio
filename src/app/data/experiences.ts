export const experiencesData = [
  {
    ...
    summary: "Na graduação em Arquitetura e Urbanismo, venho descobrindo minha afinidade pela área urbanística. Através de monitorias e do estágio no escritório Regina Neri Arquitetura, aprimoro minhas habilidades em Revit, Sketchup, comunicação e proatividade.",
  ...
  },
  {
    ...
    summary: "No Colégio Militar do Recife (2020-2022), participei de atividades extracurriculares como esportes coletivos e equipe de cerimônias, que foram fundamentais para aprimorar minhas habilidades de comunicação, oratória e trabalho em equipe.",
